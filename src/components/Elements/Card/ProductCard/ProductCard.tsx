...
export function ProductCard({ name, price, imageUrl }: CardProps) {
  return (
    <article
      ...
      duration-300 hover:translate-x-3 hover:-translate-y-3
    ...
    >
      ...
      />
      <div
        className="text-white bottom-0 sm:flex sm:items-center
        sm:justify-between font-AlbertSans p-2 border-2 border-primary"
      >
        <p
